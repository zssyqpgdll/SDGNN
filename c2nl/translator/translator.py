...
class Translator(object):
    ...
    def translate_batch(self, batch_inputs):
        ...
        code_node_type_index_rep = batch_inputs['code_node_type_index_rep']
        code_node_type_mask_rep = batch_inputs['code_node_type_mask_rep']
        ...
        if model_name == 'Transformer':
            memory_bank, layer_wise_outputs = encoder(code_rep, code_len, code_struc_rep, code_node_type_mask_rep)
